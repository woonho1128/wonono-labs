...
{{
  "personality_type": "유형 이름 (예: 따뜻한 리더, 깊은 사색가 등 창의적인 한국어 이름)",
  ...
  "advice": "맞춤형 조언 (2~3문장)",
  "compatible_type": "이 유형과 궁합이 좋은 유형 설명 (2~3문장, 어떤 성격의 사람과 잘 맞는지)",
  "incompatible_type": "이 유형과 궁합이 안 맞는 유형 설명 (2~3문장, 어떤 성격과 충돌하는지)",
  "quote": "이 성격 유형에게 어울리는 인생 명언이나 격언 1개 (명언 - 저자 형식)",
  "stress_behavior": "스트레스를 받을 때 이 유형이 보이는 행동 패턴과 대처법 (3~4문장)",
  "suitable_jobs": ["적합한 직업1", "적합한 직업2", "적합한 직업3", "적합한 직업4"],
  "growth_point": "이 유형이 더 성장하기 위해 필요한 구체적인 포인트와 방법 (3~4문장)"
}}
